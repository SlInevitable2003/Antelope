...
class ArithmeticSharedTensor(object):
    ...
    def conv2d_back(self, grad, **kwargs):
        return self._arithmetic_function(grad, "conv2d_back", **kwargs)
    ...
    def max_pool2d(self, kernel_size, padding, stride, return_indices=True):
        ...
        """
        from . import maxpool
        return maxpool.max_pool2d(self,kernel_size=kernel_size,stride=stride)
