...
class BatchNorm2d(Module):
    ...
    def __init__(self, num_features, eps=1e-05, momentum=0.1):
        ...
        pytorch_module = torch.nn.BatchNorm2d(num_features)

        self.register_parameter("weight",pytorch_module.weight)
        self.register_parameter("bias",pytorch_module.bias)
        self.register_buffer("running_mean",pytorch_module.running_mean)
        self.register_buffer("running_var",pytorch_module.running_var)
        self.register_buffer("inv_running_var", pytorch_module.running_var)
    ...
    def from_onnx(parameters=None, attributes=None):
        ...
        module = BatchNorm2d(num_features, **kwargs)
